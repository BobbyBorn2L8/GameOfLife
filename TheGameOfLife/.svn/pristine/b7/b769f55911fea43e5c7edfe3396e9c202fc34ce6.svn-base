...
public class BlueTile extends Tile {
	...
	public void onLand(GamePlayer player, GameBoard board, Graphics2D panel) {
		...
		if (n == 1) 
		{
			JOptionPane.showMessageDialog(null, "You do nothing", "", JOptionPane.INFORMATION_MESSAGE, null);
		}
	}
	...
	public void visitAttraction(GamePlayer player, GameBoard board) {
		...
		JOptionPane.showMessageDialog(null, board.getAttractions().get(getMultiplier()).getAssetName() + " is added to your inventory", "", JOptionPane.INFORMATION_MESSAGE, null);
	}
	...
	public void upgradeCar(GamePlayer player) {
		...
		{
			JOptionPane.showMessageDialog(null, "Your car is already fully upgraded", "", JOptionPane.INFORMATION_MESSAGE, null);
	...
	public void getNewHouse(GamePlayer player, GameBoard board) {
		...
		if (getMultiplier() == 0 && board.getFallsHouses().getDeck().size() > 0) {
			...
			JOptionPane.showMessageDialog(null, "There are no more houses in this area", "", JOptionPane.INFORMATION_MESSAGE, null);
		}
	}
}
