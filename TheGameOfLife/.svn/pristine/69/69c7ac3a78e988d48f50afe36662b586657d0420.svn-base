...
public class RedTile extends Tile 
{
	...
	public boolean getMarried(GamePlayer player, GameBoard board, Graphics2D panel)
	{
		...
		{
			JOptionPane.showMessageDialog(board.getMainFrame(), "HAPPY ANNIVERSARY!!! Collect £1000", "", 
					JOptionPane.INFORMATION_MESSAGE, null);
			player.addToPlayerBankBalance(1000);
		}
		else
		{
			JOptionPane.showMessageDialog(board.getMainFrame(), "Meet the love of your life: Get married", "", 
					JOptionPane.INFORMATION_MESSAGE, null);
