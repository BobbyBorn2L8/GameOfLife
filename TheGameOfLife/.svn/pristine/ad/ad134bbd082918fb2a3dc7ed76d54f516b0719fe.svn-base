...
public class GameLogic implements Serializable{
	...
	public GameLogic(ArrayList<GamePlayer> players, GameBoard board)
	{
		...
		this.playersRanked = new ArrayList<GamePlayer>(players);
		this.currentIndex = 0;
	...
	public void startGameOnFirstPlayer()
	{
		...
		System.out.println("Player: " + players.get(currentIndex).getPlayerName());
		System.out.println("Players Size" + players.size());
		System.out.println(players.toString());
		if(currentPlayer.isFirstTurn())
		{
			currentPlayer.setPlayerBankBalance(1000);
	...
	public void mouseClickedLogic(int xCoord, int yCoord, GameBoard board)
	{
		...
		{
			gameLog.addLog("Span the spinner");
	...
	public void checkPlayerAge(GamePlayer player)
	{
		if(playerMustRetire(player))
		{
			...
			Object[] options = {"OK"};
			JOptionPane.showOptionDialog(null,  currentPlayer.getPlayerName() + " you have retired! Congratulations!", "Time To Retire!", JOptionPane.PLAIN_MESSAGE, JOptionPane.PLAIN_MESSAGE, null, options, options[0]);
		}
	...
	{
		GameAssetHouse fallsHouse1 = new GameAssetHouse("Small Detached House", District.Falls, 10000, "card_House03.png");
		allHouses.add(fallsHouse1);
		GameAssetHouse fallsHouse2 = new GameAssetHouse("Medium Detached House", District.Falls, 15000, "card_House04.png");
		allHouses.add(fallsHouse2);
		GameAssetHouse fallsHouse3 = new GameAssetHouse("Large Detached House", District.Falls, 17500, "card_House05.png");
		allHouses.add(fallsHouse3);
		
		GameAssetHouse uniHouse1 = new GameAssetHouse("Standard Box", District.University, 8000, "card_House01.png");
		allHouses.add(uniHouse1);
		GameAssetHouse uniHouse2 = new GameAssetHouse("Large Box", District.University, 9000, "card_House02.png");
		allHouses.add(uniHouse2);
		GameAssetHouse uniHouse3 = new GameAssetHouse("Standard Student House", District.University, 5000, "card_House12.png");
		allHouses.add(uniHouse3);
		GameAssetHouse uniHouse4 = new GameAssetHouse("Large Student House", District.University, 10000, "card_House13.png");
		allHouses.add(uniHouse4);
		
		GameAssetHouse cathedralHouse1 = new GameAssetHouse("Luxury City Apartment", District.Cathedral, 60000, "card_House09.png");
		allHouses.add(cathedralHouse1);
		GameAssetHouse cathedralHouse2 = new GameAssetHouse("Penthouse City Apartment", District.Cathedral, 100000, "card_House10.png");
		allHouses.add(cathedralHouse2);
		GameAssetHouse cathedralHouse3 = new GameAssetHouse("City Mansion", District.Cathedral, 150000, "card_House11.png");
		allHouses.add(cathedralHouse3);

		GameAssetHouse titanicHouse1 = new GameAssetHouse("Standard Apartment", District.Titanic, 85000, "card_House06.png");
		allHouses.add(titanicHouse1);
		GameAssetHouse titanicHouse2 = new GameAssetHouse("Luxury Apartment", District.Titanic, 29500, "card_House07.png");
		allHouses.add(titanicHouse2);
		GameAssetHouse titanicHouse3 = new GameAssetHouse("Titanic Apartment", District.Titanic, 40000, "card_House08.png");
	...
	{
		GameAssetAttraction attraction1 = new GameAssetAttraction(50, 100, "Frisbee", "card_Sou01.png");
		allAttractions.add(attraction1);
		GameAssetAttraction attraction2 = new GameAssetAttraction(100, 150, "Ticket Stub", "card_Sou02.png");
		allAttractions.add(attraction2);
		GameAssetAttraction attraction3 = new GameAssetAttraction(150, 200, "Candle", "card_Sou03.png");
		allAttractions.add(attraction3);
		GameAssetAttraction attraction4 = new GameAssetAttraction(100, 200, "Flim Ticket", "card_Sou04.png");
		allAttractions.add(attraction4);
		GameAssetAttraction attraction5 = new GameAssetAttraction(150, 250, "Selfie at Lanyon & QUB Hoodie", "card_Sou05.png");
		allAttractions.add(attraction5);
		GameAssetAttraction attraction6 = new GameAssetAttraction(200, 300, "Tenants Vital Festival Gear", "card_Sou06.png");
		allAttractions.add(attraction6);
		GameAssetAttraction attraction7 = new GameAssetAttraction(150, 350, "Selfie with Big Fish", "card_Sou07.png");
		allAttractions.add(attraction7);
		GameAssetAttraction attraction8 = new GameAssetAttraction(200, 400, "Replica Painting", "card_Sou08.png");
		allAttractions.add(attraction8);
		GameAssetAttraction attraction9 = new GameAssetAttraction(250, 450, "Crate of Local Beer", "card_Sou09.png");
		allAttractions.add(attraction9);
		GameAssetAttraction attraction10 = new GameAssetAttraction(200, 500, "Replica Titanic Boat", "card_Sou10.png");
		allAttractions.add(attraction10);
		GameAssetAttraction attraction11 = new GameAssetAttraction(250, 550, "Titanic: Studios Game of Thrones Merch", "card_Sou11.png");
		allAttractions.add(attraction11);
		GameAssetAttraction attraction12 = new GameAssetAttraction(300, 600, "Titanic: SSE Arena Concert Tickets & VIP", "card_Sou12.png");
	...
	public double endGameTotalForPlayer(GamePlayer player)
	{
		...
		{
			double loanAmount = iterator.next().getLoanAmount() * 2;
			assetsValue -= loanAmount;
			player.setLoanValue((int) loanAmount);
		}
		...
		player.setAssetsValue((int) assetsValue);
		player.setHouseValue((int) houseValue);
		player.setCarValue((int) carValue);
		player.setFamilyValue((int) familyValue);
