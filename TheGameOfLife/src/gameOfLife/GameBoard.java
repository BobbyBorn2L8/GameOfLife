...
public class GameBoard extends CommonScreenAttributes{
	 ...
	 */
	private Decks<Careers> uniCareers = new Decks<Careers>(0, 0, "deck_Career.png");
	private Decks<Careers> careers = new Decks<Careers>(0, 0, "deck_Uni.png");
	private Decks<GameAssetHouse> uniHouses = new Decks<GameAssetHouse>(0, 0, "deck_House.png");
	private Decks<GameAssetHouse> fallsHouses = new Decks<GameAssetHouse>(0, 0, "deck_House.png");
	private Decks<GameAssetHouse> cathedralHouses = new Decks<GameAssetHouse>(0, 0, "deck_House.png");
	private Decks<GameAssetHouse> titanicHouses = new Decks<GameAssetHouse>(0, 0, "deck_House.png");
	...
	public void prepareImages()
	{
		try
	    {
	    	...
	    	this.fallsImage = ImageIO.read(getClass().getResource("Quarter_Img05.png"));
	    	this.uniImage = ImageIO.read(getClass().getResource("Quarter_Img03.png"));
	    	this.cathedralImage = ImageIO.read(getClass().getResource("Quarter_Img04.png"));
	    	this.titanicImage = ImageIO.read(getClass().getResource("Quarter_Img02.png"));
	    }
	    catch (IOException e) 
	    {
	...
	public void prepareGUI()
	{
		...
		controlPanel.setBackground(new Color(239, 253, 222));
	...
	public void showCanvas()
	{
	    ...
	    if(!gameLogic.isSavedGame())
	    {
			...
			}while(!inputIsInt(retirementAge) || Integer.parseInt(retirementAge) < 50 || 
					Integer.parseInt(retirementAge) > 80 || (Integer.parseInt(retirementAge) % 10 != 0));
	...
	{
		Careers career1 = new Careers("card_Career01.png", "Artist", 5000);
		careers.addCard(career1);
		Careers career2 = new Careers("card_Career02.png", "Chef", 10000);
		careers.addCard(career2);
		Careers career3 = new Careers("card_Career03.png", "Manager", 25000);
		careers.addCard(career3);
		Careers career4 = new Careers("card_Career04.png", "Fireman", 8000);
		careers.addCard(career4);
		Careers career5 = new Careers("card_Career05.png", "Police", 7000);
		careers.addCard(career5);
		
		Careers uniCareer1 = new Careers("card_Uni01.png", "Doctor", 40000);
		uniCareers.addCard(uniCareer1);
		Careers uniCareer2 = new Careers("card_Uni02.png", "Accountant", 30000);
		uniCareers.addCard(uniCareer2);
		Careers uniCareer3 = new Careers("card_Uni03.png", "Chemical Engineer", 90000);
		uniCareers.addCard(uniCareer3);
		Careers uniCareer4 = new Careers("card_Uni04.png", "Software Engineer", 30000);
		uniCareers.addCard(uniCareer4);
		Careers uniCareer5 = new Careers("card_Uni05.png", "Lawyer", 50000);
...
class GameCanvas extends Canvas {
	 ...
	 */
     public GameCanvas(GameBoard board) 
     {
    	  ...
    	  // 232,181,30
          setBackground(new Color(239, 253, 222));
      ...
      */
      ...
      {
    	  for (int iii = gameLogic.getPlayers().size() - 1; iii >= 0; iii--) 
    	  {
    		  GamePlayer player = gameLogic.getPlayers().get(iii);
    		  if(player.isInGame())
    		  {
